...
# print(lista.index('Ana', 0, 4)) #mostra a posição de um determinado valor da lista. Podemos passar o começo e o final do range.
...
# lista.sort(reverse=True)#orderna a lista do final para o início
# print(lista)
