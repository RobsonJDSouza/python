...
Imutabilidade: 
As tuplas são imutáveis, o que significa que você não pode alterar os elementos individuais de uma tupla após sua criação. No entanto, você pode criar uma nova tupla com elementos diferentes.

Ordenadas: 
Os elementos em uma tupla são mantidos em uma ordem específica, o que significa que você pode acessar os elementos por meio de índices.

Heterogeneidade: 
Assim como em listas, os elementos em uma tupla podem ser de diferentes tipos de dados, como inteiros, strings, floats, outras tuplas e assim por diante.

Sintaxe: 
As tuplas são definidas usando parênteses () ou simplesmente separando os elementos por vírgula. Mesmo que os parênteses sejam opcionais, é uma prática comum usá-los para deixar claro que você está criando uma tupla.
